          ...
          <div class="container-xxl">
            <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4">
              <a href="index.html" class="app-brand-link">
                <span class="app-brand-text demo menu-text fw-bold">ChatFit</span>
              </a>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a
                    ...
                    <div class="avatar avatar-online">
                      <input type="button" onclick="goLogin()" value="로그인" id="login">
                    </div> 
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                ...
                <ul class="menu-inner pb-2 pb-xl-0">
                  ...
                  <li class="menu-item active">
                    <a href="javascript:void(0)" class="menu-link menu-toggle">
                      ...
                      <div data-i18n="Dashboards">Chatfit Ai</div>
                    </a>
                    <ul class="menu-sub">
                      <li class="menu-item active">
                        <a href="index.html" class="menu-link">
                          <i class="menu-icon tf-icons ti ti-chart-pie-2"></i>
                          <div data-i18n="Analytics">Menu Ai</div>
                        </a>
                      </li>
                      <li class="menu-item">
                        <a href="dashboards-crm.html" class="menu-link">
                          <i class="menu-icon tf-icons ti ti-3d-cube-sphere"></i>
                          <div data-i18n="CRM">게시판</div>
                        </a>
                      </li>
                      <li class="menu-item">
                        <a href="app-ecommerce-dashboard.html" class="menu-link">
                          <i class="menu-icon tf-icons ti ti-shopping-cart"></i>
                          <div data-i18n="eCommerce">뉴스</div>
                        </a>
                      </li>
                      <li class="menu-item">
                        <a href="app-logistics-dashboard.html" class="menu-link">
                          <i class="menu-icon tf-icons ti ti-truck"></i>
                          <div data-i18n="Logistics">운동지식</div>
                        </a>
                      </li>
                      <li class="menu-item">
                        <a href="app-academy-dashboard.html" class="menu-link">
                          <i class="menu-icon tf-icons ti ti-book"></i>
                          <div data-i18n="Academy">운동모임 게시판</div>
                        </a>
                      </li>
                    </ul>
                  </li>
                  ...
                  <li class="menu-item">
                    <a href="javascript:void(0)" class="menu-link menu-toggle">
                      ...
                      <div data-i18n="Layouts">Menu Ai</div>
                    </a>
                  ...
                  <li class="menu-item">
                    <a href="javascript:void(0)" class="menu-link menu-toggle">
                      ...
                      <div data-i18n="Components">운동지식</div>
                    </a>
                    <ul class="menu-sub">
                      <!-- Cards -->
                      <li class="menu-item">
                  ...
                  <li class="menu-item">
                    <a href="javascript:void(0)" class="menu-link menu-toggle">
                      <i class="menu-icon tf-icons ti ti-forms"></i>
                      <div data-i18n="Forms">운동모임게시판</div>
                    </a>
                    <ul class="menu-sub">
                      <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
